...
if __name__ == "__main__":
    ...
    print(y1.shape)           # torch.Size([2, 3, 6, 46, 46])
    print(y2.shape)           # torch.Size([2, 3, 21, 46, 46])
